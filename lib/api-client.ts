...
export const hotelsAPI = {
  ...
  search: (searchParams: Record<string, unknown>) =>
    apiClient.post("/hotels/search", searchParams),

  create: (hotelData: Record<string, unknown>) =>
    apiClient.post("/hotels", hotelData, true),

  update: (id: string, hotelData: Record<string, unknown>) =>
    apiClient.put(`/hotels/${id}`, hotelData, true),

  delete: (id: string) => apiClient.delete(`/hotels/${id}`, true),
}
...
export const adminAPI = {
  getUsers: () => apiClient.get("/admin/users", true),

  updateUserRole: (userId: string, role: string) =>
    apiClient.patch(`/admin/users/${userId}/role`, { role }, true),

  updateUserStatus: (userId: string, isActive: boolean) =>
    apiClient.patch(`/admin/users/${userId}/status`, { isActive }, true),

  getAnalytics: () => apiClient.get("/admin/analytics", true),
}
